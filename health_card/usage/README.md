...
```go
_, err := client.Usage().ReportHISData(usage.ReportHISDataRequest{QRCodeText: qrCodeText, Time: time.Now().Format("2006-01-02 15:04:05"), HospitalCode: hospitalCode, Scene: "0101011", Department: "0300", CardType: "11", CardChannel: "0401"}, session.Openid)
```
