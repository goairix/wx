// Package webhook provides typed miniapp callback handling.
package webhook
...
// Event contains common miniapp message and event fields.
type Event struct {
	...
	MenuID       string `xml:"MenuId" json:"MenuId"`
...
// Handler processes a typed miniapp event.
...
// Client stores miniapp callback credentials.
type Client struct {
	config corewebhook.CallbackConfig
}

// NewClient constructs a miniapp callback adapter.
